        ...
        while(flag == true)
        {
            ...
            switch(userInput)
            {
                case "1":
                    ...
                    id = scanner.nextLine();                                                            //        Semester          Year               Program        Roll No.
                    boolean yes = id.matches("^((?:[A-Z]{2})?\\d{2})-+(.+?)-(\\d{4})$");  // format of {(2 letters A-Z)(2 digit number)(-)(4 letters A-Z)(-)(4 digit number)}  Example: SP18-BSCS-0325
                    if (yes){
